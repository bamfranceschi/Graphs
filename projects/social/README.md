...
1. To create 100 users with an average of 10 friends each, how many times would you need to call `add_friendship()`? Why?
   ...
   500 times! Each call creates two friendships. Number of users \* average friendships // 2.

2. If you create 1000 users with an average of 5 random friends each, what percentage of other users will be in a particular user's extended social network? 80-90%

What is the average degree of separation between a user and those in his/her extended network?
average of 4 In 1000 / ln 5 = log5(1000) = 4.29, round down
